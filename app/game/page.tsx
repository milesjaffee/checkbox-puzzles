  ...
  export default function Page() {
    return (
      <section>
        ...
        <ol className="flex gap-4 items-center flex-col sm:flex-col">
            <li>
                <a
                className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-background text-background gap-2 hover:bg-[#38383877] font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto"
                href="/game/puzzle1"
                target="_blank"
